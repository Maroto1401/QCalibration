    ...
    series: [
      ...
      },
      {
        ...
        data: [
          ...
          result.circuit.n_two_qubit_gates,
          result.circuit.depth,
          result.circuit.n_cx_gates,
          result.circuit.n_swap_gates
        ],
    ...
    series: [
      {
        ...
        data: [
          { 
            value: (result.metrics.error_rate * 100).toFixed(2), 
            itemStyle: { color: '#fa5252' } 
          },
          { 
            value: (result.metrics.fidelity * 100).toFixed(2), 
